...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/company/wyloks',
      icon: (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="text-gray-400 text-sm sm:text-base flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <p>
              © {currentYear} Wyloks. All rights reserved.
            </p>
            <nav aria-label="Footer policies">
              <ul className="flex space-x-6">
                ...
                <li>
                  <Link href="/terms-of-service" className="hover:text-purple-400 transition-colors duration-200">
                    Terms of Service
                  </Link>
                </li>
                <li>
                  <Link href="/cookie-policy" className="hover:text-purple-400 transition-colors duration-200">
                    Cookie Policy
                  </Link>
                </li>
              </ul>
