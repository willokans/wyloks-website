        ...
        <section className="mb-8">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-2">
                We use Google reCAPTCHA to protect our contact forms from spam and abuse. This service sets cookies to verify that you&apos;re a real person when submitting forms. For more information about reCAPTCHA, please visit Google&apos;s{' '}
                <a
